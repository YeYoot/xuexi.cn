...
USER_CONFIG = {
    ...
    "read_time": 130,  # 一篇文章的阅读时间，不建议修改 130
    "video_time": 185,  # 一部视频的观看时间，不建议修改 185
}
...
WEBSITE = {
    ...
    "xpath": {
        "login": {
            "login_btn": '//*[@id="root"]/div/div[1]/header/div[2]/div[2]/a[2]',
            "login_text": '//*[@class="ddlogintext"]',
            "success": '//*[@id="app"]/div/div[2]/div/div/div[1]/div/a[3]/div/div[2]/div[1]/span',
            "login_success": '//*[@id="root"]/div/div[1]/header/div[2]/div[2]/span/span',
        },
        "points": {
        ...
        "read": {
            "shiping_title": '//*[@id="f657"]/div/div/div/div/div/section/div/div/div/div/div[1]/div/div/div[2]/span',
        ...
        "video": {
            ...
            "next_btn": '//*[@class="btn"]',
            "tv": '//*[@id="root"]/div/div[1]/header/div[2]/div[1]/div[2]/a[2]',
